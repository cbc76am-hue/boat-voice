...
_MARINE_INITIAL_PROMPT = (
    ...
    "Everett, Edmonds, Mukilteo, Kingston, Shilshole, Bell Harbor, "
    "Lummi Island, Camano Island, Marrowstone, Possession Sound, "
    "Tulalip, Saratoga Passage, "
    "Ballard Locks, Hiram M Chittenden Locks, Lake Union, Lake Washington, "
